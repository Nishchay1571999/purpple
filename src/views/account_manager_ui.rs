use gtk4::prelude::*;
use gtk4::{
    Box, Button, CellRendererText, Label, ListStore, Orientation,
    ScrolledWindow, TreeView, TreeViewColumn,
};

use crate::components::searchEntry;

pub fn create_account_manager_page() -> Box {
    let vbox = Box::new(Orientation::Vertical, 10);

    let search_bar = searchEntry::create_new_search_entry("Search some accounts ...");
